...
export default function PostCard({post, onDeleteClick}){
    ...
    return(
        <div className="bg-white shadow-sm rounded flex flex-xol">
            ...
            <div className="p-2">
                ...
                <div className="flex space-x-3">
                    ...
                    <Link onClick={onDeleteClick} className="w-8 h-8 rounded-full bg-red-400 hover:bg-red-600 flex justify-center items-center text-white">
                        <BsTrash />
                    </Link>
                </div>
            </div>          
